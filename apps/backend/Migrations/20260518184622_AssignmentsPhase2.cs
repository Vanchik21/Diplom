...
{
    /// <inheritdoc />
    public partial class AssignmentsPhase2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedMetrics = table.Column<string>(type: "text", nullable: false, defaultValue: "{}"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ObservedMetrics = table.Column<string>(type: "text", nullable: false, defaultValue: "{}"),
                    GradingRows = table.Column<string>(type: "text", nullable: false, defaultValue: "[]"),
